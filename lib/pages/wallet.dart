                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                    child: Text(
                                  "Total Harga : \Rp${_walletController.totalAmount().toStringAsFixed(2)}",
                                  style: GoogleFonts.lato(
                                      fontSize: 19,
                                      fontWeight: FontWeight.w500,
                                      color: Colors.white),
                              ...
                              child: Stack(children: [
                                ...
                                Positioned(
                                  ...
                                  child: FadeInLeft(
                                    ...
                                    child: Text(
                                      "\Rp${_walletController.walletFood[index].price.toStringAsFixed(2)}",
                                      style: GoogleFonts.oxygen(
                                          color: Colors.black,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 23),
                                        ...
                                        child: IconButton(
                                            onPressed: () {
                                              Get.defaultDialog(
                                                  ...
                                                  title: "Perhatian",
                                                  content: const Text(
                                                    "Apa Anda Yakin Mau Menghapus Pesanan Anda?",
